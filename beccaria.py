...
lost_font = pygame.font.SysFont('arial', 35)
word = ''
buttons = []
guessed = []
...
def end(winner=False):
    global limbs
    lostTxt = 'Hai perso, premi qualunque tasto per giocare di nuovo'
    winTxt = 'Hai vinto premi qualunque tasto per giocare ancora'
    redraw_game_window()
    ...
    wordWas = lost_font.render('La frase era: ', 1, BLACK)
